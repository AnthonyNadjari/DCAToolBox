...
DAILY_UNIVERSE: dict[str, tuple[list[str], str]] = {
    ...
    "ESE FP Equity": (OHLCV + ["PX_BID", "PX_ASK", "FUND_NET_ASSET_VAL",
                               "TOT_RETURN_INDEX_GROSS_DVDS", "EQY_SH_OUT"], "2013-09-16"),
    "CL2 FP Equity": (OHLCV + ["PX_BID", "PX_ASK", "FUND_NET_ASSET_VAL",
                               "TOT_RETURN_INDEX_GROSS_DVDS"], "2009-01-01"),
    "LQQ FP Equity": (OHLCV + ["PX_BID", "PX_ASK", "FUND_NET_ASSET_VAL",
                               "TOT_RETURN_INDEX_GROSS_DVDS"], "2009-01-01"),
