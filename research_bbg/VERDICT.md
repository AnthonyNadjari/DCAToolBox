...
re-confirmed for BoursoBank PEA: 0.5% on BUY and 0.5% on SELL (sales are
never free, even for BoursoMarkets partner ETFs; CL2/LQQ are Amundi, not
...
Findings:
1. Post-2009 the NO-GATE leveraged mix dominates everything: 100% of rolling
   windows beat ESE, worst 5y window still +14.6% ahead. The era contained
   only V-shaped bears, so the gate collected no payout and paid ~9pp/yr of
   whipsaw premium. This is the known insurance cost, now measured on real
   fund prices.
...
4. Timing the UNLEVERED fund remains value-destroying in every era tested
   (ESE + gate: -9.6% median 5y excess).

Unchanged conclusion, sharpened: the gate is pure long-bear insurance on
the leveraged sleeve. Post-2009 measures the premium (~9pp/yr in a melt-up
